...
rule select_variant_feats:
    ...
    benchmark:
        f"{outputs}/benchmarks/{pipeline}_var_{batch}.bwa.benchmark.txt"
    run:
...
rule mad:
    ...
    benchmark:
        f"{outputs}/benchmarks/{pipeline}_mad_{batch}.bwa.benchmark.txt"
    run:
...
rule outlier_removal:
    ...
    benchmark:
        f"{outputs}/benchmarks/{pipeline}_outlier_{batch}.bwa.benchmark.txt"
    run:
...
rule feat_select:
    ...
    benchmark:
        f"{outputs}/benchmarks/{pipeline}_feat_select_{batch}.bwa.benchmark.txt"
    run:
