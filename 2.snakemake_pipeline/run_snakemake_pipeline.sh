...
snakemake \
    ...
    --cores all &> outputs/snakemake_logs/snakemake_batch13_new.log
...
snakemake \
    ...
    --cores all &> outputs/snakemake_logs/snakemake_batch14_new.log
...
nohup snakemake \
    ...
    --cores all &> outputs/snakemake_logs/snakemake_batch7_new.log
rm Snakefile_batch7
...
nohup snakemake \
    ...
    --cores all &> outputs/snakemake_logs/snakemake_batch8_new.log
rm Snakefile_batch8
...
snakemake \
    ...
    --cores all &> outputs/snakemake_logs/snakemake_batch18_new.log
rm Snakefile_batch18

## Run batch 19
cp inputs/snakemake_files/Snakefile_batch19 .
snakemake \
    --snakefile Snakefile_batch19 \
    --cores all &> outputs/snakemake_logs/snakemake_batch19_new.log
rm Snakefile_batch19